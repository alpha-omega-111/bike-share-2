...
def get_filters():
    ...
    Args:
        (str) city - name of the city to analyze, not sensitive to capitalisation
        (str) month - name of the month to filter by, or "all" to apply no month filter, not sensitive to capitalisation
        (str) day - name of the day of week to filter by, or "all" to apply no day filter, not sensitive to capitalisation
